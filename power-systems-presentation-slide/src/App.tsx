...
const slides = [
  ...
  { id: 3, text: "Integrating both sides: v = (1/C) ∫ i dt", formula: "v = (1/C) ∫ i dt" },
  { id: 4, text: "Meaning: Voltage depends on accumulation of current (capacitor stores charge)" },
  { id: 5, text: "Applying AC Current: i = Im sin(ωt)", formula: "i = Im sin(ωt)" },

  { id: 6, text: "Applying AC Voltage: v(t) = Vm sin(ωt)" },
  { id: 7, text: "Current Derived: i(t) = ωC Vm sin(ωt + 90°)", formula: "i(t) = ωC Vm sin(ωt + 90°)" },
  { id: 8, text: "Capacitive Reactance: XC = 1/(ωC) = 1/(2πfC)", formula: "XC = 1/(2πfC)" },
  { id: 9, text: "Analysis: XC ∝ 1/f (Inversely Proportional)", highlight: true },
  { id: 10, text: "Frequency Increase → Reactance Decreases → Current Increases" },
  { id: 11, text: "Frequency Decrease → Reactance Increases → Current Decreases" },
  { id: 12, text: "Impact: Capacitor banks, Shunt capacitance & Voltage regulation" },
],
    notes: [
